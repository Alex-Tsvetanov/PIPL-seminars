...
public class Main {
    public static void main(String[] args) {
        ...
        // Solution 1:
        System.out.println(Arrays.stream(test).min(Comparator.comparing(String::length)).get());
        System.out.println(Arrays.stream(test).max(Comparator.comparing(String::length)).get());
        // Solution 2:
